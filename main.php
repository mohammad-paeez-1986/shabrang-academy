...
<head>
    ...
    <meta name="description" content="بهترین آموزشگاه آرایشگری مردانه در تهران با مدرک فنی حرفه ای، شهریه اقساطی و آموزش عملی زیر نظر مربیان مجرب. برای ثبت نام و مشاوره رایگان تماس بگیرید.">
        ...
        <div class="max-w-6xl mx-auto px-4">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="hidden md:flex items-center gap-1">
                    ...
                    <a href="#faq" class="px-3 py-2 text-sm font-medium text-gray-600 hover:text-brand-900 transition-colors rounded-lg hover:bg-gray-50">سوالات</a>
            ...
            <div id="mobile-menu" class="hidden md:hidden pb-4 border-t border-gray-100 mt-2 pt-4">
                <div class="flex flex-col gap-1">
                    ...
                    <a href="#faq" class="px-4 py-3 text-sm font-medium text-gray-600 hover:text-brand-900 hover:bg-gray-50 rounded-lg transition-colors">سوالات</a>
    ...
    <main>
                    ...
                    <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 mb-6">
                        <div class="flex items-center gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500">امکان پرداخت شهریه به صورت قسطی</p>
                            </div>
                        </div>
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg transition-shadow">
                        <div class="w-14 h-14 bg-brand-100 rounded-2xl flex items-center justify-center mb-6">
                            <svg class="w-7 h-7 text-brand-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg transition-shadow">
                        ...
                        <h3 class="font-bold text-gray-900 text-lg mb-3">قسطی بدون بهره</h3>
            ...
            <div class="max-w-6xl mx-auto px-4">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 text-center hover:shadow-lg transition-shadow">
                        ...
                        <p class="text-gray-600 text-sm">پرداخت شهریه به صورت قسطی</p>
                    </div>
                    <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 text-center hover:shadow-lg transition-shadow">
                        <div class="w-14 h-14 bg-brand-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
                            <svg class="w-7 h-7 text-brand-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="bg-gray-50 rounded-3xl p-8">
                        ...
                        <div class="mt-6 p-4 bg-white rounded-xl border border-gray-100">
                            <p class="text-sm text-gray-600 flex items-center gap-2">
                                <svg class="w-5 h-5 text-brand-900 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section id="faq" class="py-20 bg-white">
            <div class="max-w-4xl mx-auto px-4">
                <div class="text-center mb-16">
                    <span class="inline-block text-brand-900 font-bold text-sm mb-3">سوالات متداول</span>
                    <h2 class="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4">پاسخ به سوالات شما</h2>
                </div>
                <div class="space-y-4" id="faq-list">
                    <div class="faq-item bg-gray-50 rounded-2xl border border-gray-100">
                        <button onclick="toggleFaq(this)" class="w-full flex items-center justify-between p-6 text-right hover:bg-gray-100 rounded-2xl transition-colors">
                            <span class="font-bold text-gray-900">هزینه آموزش آرایشگری مردانه چقدر است؟</span>
                            <svg class="faq-icon w-5 h-5 text-brand-900 transition-transform duration-300 flex-shrink-0 mr-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                        <div class="faq-answer hidden px-6 py-6 font-light">
                            <p class="text-gray-600 leading-relaxed">
                                هزینه آموزشگاه آرایشگری مردانه از طریق سازمان صنفی اعلام میشود و برای همه آموزشگاه ها یکسان است.
                                البته هزینه کارآموز بر اساس دوره هایی که برای گذراندن انتخاب کرده متغیر است. در نظر داشته باشید که برای دریافت مدرک فنی حرفه ای باید حداقل دوره دوره پیرایش درجه دو را بگذرانید.
                            </p>
                        </div>
                    </div>
                    <div class="faq-item bg-gray-50 rounded-2xl border border-gray-100">
                        <button onclick="toggleFaq(this)" class="w-full flex items-center justify-between p-6 text-right hover:bg-gray-100 rounded-2xl transition-colors">
                            <span class="font-bold text-gray-900">آیا امکان پرداخت اقساطی شهریه وجود دارد؟</span>
                            <svg class="faq-icon w-5 h-5 text-brand-900 transition-transform duration-300 flex-shrink-0 mr-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                        <div class="faq-answer hidden px-6 py-6 font-light">
                            <p class="text-gray-600 leading-relaxed">بله، در آموزشگاه شبرنگ امکان پرداخت شهریه به صورت قسطی طی دو ماه فراهم شده است تا از نظر پرداخت شهریه مشکل خاصی برای کارآموزان به وجود نیاید.</p>
                        </div>
                    </div>

                    <div class="faq-item bg-gray-50 rounded-2xl border border-gray-100">
                        <button onclick="toggleFaq(this)" class="w-full flex items-center justify-between p-6 text-right hover:bg-gray-100 rounded-2xl transition-colors">
                            <span class="font-bold text-gray-900">مدرک فنی حرفه ای چیست و چگونه دریافت می شود؟</span>
                            <svg class="faq-icon w-5 h-5 text-brand-900 transition-transform duration-300 flex-shrink-0 mr-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                        <div class="faq-answer hidden px-6 py-6 font-light">
                            <p class="text-gray-600 leading-relaxed">پس از اتمام دوره آموزش، هنرجویان جهت شرکت در آزمون های فنی حرفه ای معرفی می شوند. آزمون ها در دو قسمت تئوری و عملی گرفته می شوند. پس از قبولی در هر دو آزمون تقریبا بعد از یک الی دو هفته گواهینامه مهارت آماده می باشد. حداقل نمره قبولی ۵۰ از ۱۰۰ است.</p>
                        </div>
                    </div>
                    <div class="faq-item bg-gray-50 rounded-2xl border border-gray-100">
                        <button onclick="toggleFaq(this)" class="w-full flex items-center justify-between p-6 text-right hover:bg-gray-100 rounded-2xl transition-colors">
                            <span class="font-bold text-gray-900">ساعات کاری آموزشگاه چگونه است؟</span>
                            <svg class="faq-icon w-5 h-5 text-brand-900 transition-transform duration-300 flex-shrink-0 mr-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                        <div class="faq-answer hidden px-6 py-6 font-light">
                            <div class="space-y-2 text-gray-600">
                                ساعت کاری آموزشگاه آرایشگری مردانه شبرنگ شنبه تا چهارشنبه از ۹ صبح تا ۷ غروب میباشد.
                                اما کارآموزان در صورت درخواست میتوانند ساعات و روزهای حضور خود را تنظیم نمایند.
                            </div>
                        </div>
                    </div>
                    <div class="faq-item bg-gray-50 rounded-2xl border border-gray-100">
                        <button onclick="toggleFaq(this)" class="w-full flex items-center justify-between p-6 text-right hover:bg-gray-100 rounded-2xl transition-colors">
                            <span class="font-bold text-gray-900">آیا آموزشگاه دوره تکمیلی رایگان دارد؟</span>
                            <svg class="faq-icon w-5 h-5 text-brand-900 transition-transform duration-300 flex-shrink-0 mr-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                        <div class="faq-answer hidden px-6 py-6 font-light">
                            <p class="text-gray-600 leading-relaxed">بله، آموزشگاه شبرنگ برای هنرجویانی که آشنایی حدودی با آرایشگری دارند یا مدرک درجه دو خود را گرفته‌اند، دوره تکمیلی رایگان برگزار می‌نماید. این دوره حدود یک ماه می باشد و شامل آموزش مدل موهای جدید است.</p>
                        </div>
                    </div>
                    <div class="faq-item bg-gray-50 rounded-2xl border border-gray-100">
                        <button onclick="toggleFaq(this)" class="w-full flex items-center justify-between p-6 text-right hover:bg-gray-100 rounded-2xl transition-colors">
                            <span class="font-bold text-gray-900">آیا با مدرک درجه دو می توان جواز کسب گرفت؟</span>
                            <svg class="faq-icon w-5 h-5 text-brand-900 transition-transform duration-300 flex-shrink-0 mr-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                        <div class="faq-answer hidden px-6 py-6 font-light">
                            <p class="text-gray-600 leading-relaxed">بله، با داشتن تنها مدرک درجه دو قادر به اقدام جهت جواز کسب نیز می باشید. همچنین میتوانید از مراکز اشتغال زایی و صندوق های مربوطه وام دریافت نمایید.</p>
                        </div>
                    </div>
                    <div class="faq-item bg-gray-50 rounded-2xl border border-gray-100">
                        <button onclick="toggleFaq(this)" class="w-full flex items-center justify-between p-6 text-right hover:bg-gray-100 rounded-2xl transition-colors">
                            <span class="font-bold text-gray-900">آیا آموزشگاه پشتیبانی آموزشی دارد؟</span>
                            <svg class="faq-icon w-5 h-5 text-brand-900 transition-transform duration-300 flex-shrink-0 mr-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                        <div class="faq-answer hidden px-6 py-6 font-light">
                            <p class="text-gray-600 leading-relaxed">بله، آموزشگاه شبرنگ تا دریافت مدرک فنی حرفه ای هنرجویان را همراهی خواهد کرد و همچنین برای رسیدن به مقصد کسب و کار و ایجاد شغل پشتیبانی آموزشی ارائه می‌دهد.</p>
                        </div>
                    </div>
                </div>
            </div>
